...
STRINGS = {
    ...
    "no_servers": ("هنوز سروری اضافه نشده", "No servers added yet"),
    "no_servers_hint": ("با دکمه «افزودن» پایین صفحه، اولین سرور را اضافه کن",
                        "Tap “Add” below to add your first server"),
    "copy_rtmp": ("کپی آدرس RTMP", "Copy RTMP address"),
    "best_badge": ("بهترین", "Best"),
    "not_scanned": ("هنوز اسکن نشده — دکمه اسکن را بزن",
                    "Not scanned yet — tap Scan"),
